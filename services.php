           ...
           <h1>Services</h1>
            <ul id="services">
                <li class="service-item">
                    ...
                    <p>Pricing: Dependent on the complexity of the project. Use the quote form to the right to tell us about your project, or <a href="contact.php">click here to contact us if you want to ask some questions before you get your quote.</a></p>
                </li>
                <li class="service-item">
